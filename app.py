...
T = {
    "ru": {
        ...
        "activated_base": "🎉 *Подписка Base активирована! Подождите пока сервер вас обновит — от 1 до 5-6 минут 🥰*\n\n👤 Ник: `{u}`\n📦 Тариф: {p}\n⏳ Действует: {e}\n\nЗапускай скрипт в Xeno:\n`loadstring(game:HttpGet('https://raw.githubusercontent.com/llostik-84587456683453285TYUIG7EGNB7E/by.llostikxCha7ok/refs/heads/main/Base.LUA'))()`",
        "activated_premium": "🎉 *Подписка Ultimate активирована! Подождите пока сервер вас обновит — от 1 до 5-6 минут 🥰*\n\n👤 Ник: `{u}`\n📦 Тариф: {p}\n⏳ Действует: {e}\n\nЗапускай скрипт в Xeno:\n`loadstring(game:HttpGet('https://raw.githubusercontent.com/llostik-84587456683453285TYUIG7EGNB7E/by.llostikxCha7ok/refs/heads/main/Ultimate.LUA'))()`",
